...
const WELCOME_MESSAGE: ChatMessage = {
  ...
  type: 'text',
  content:
    'Привет! 👋 Я навигатор отдыха — построю путь от вашего дома до курорта: электричка, автобус, поезд, перелёт. Напишите откуда и куда, например: « Из Ростова на Пхукет».',
};
